...
export const PRODUCT_ID_MAP = {
  "kenz-ai-hub":
    import.meta.env.VITE_PRODUCT_KENZ_AI_HUB || "STO-ITEM-2026-00029",
  "ai-bizz-hub":
    import.meta.env.VITE_PRODUCT_AI_BIZZ_HUB || "STO-ITEM-2026-00030",
  kenmeet: import.meta.env.VITE_PRODUCT_KENMEET || "STO-ITEM-2026-00031",
  "kenz-intent":
    import.meta.env.VITE_PRODUCT_KENZ_INTENT || "STO-ITEM-2026-00032",
  kenvoice: import.meta.env.VITE_PRODUCT_KENVOICE || "STO-ITEM-2026-00002",
  "recruify-ai":
    import.meta.env.VITE_PRODUCT_RECRUIFY_AI || "STO-ITEM-2026-00033",
